...
- [~] Dashboard redesign — multi-dashboard builder with gridstack.js drag/resize, 17 configurable widget types, per-widget filters *(in progress — M1 foundation + M2 builder + M3 core widgets + M4 new widgets complete; M5 projections next)*
- [ ] Notion sync *(post-v1)*
